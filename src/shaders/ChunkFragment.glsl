...
layout (location = 1) in vec4 v_LightSpacePos[3];
layout (location = 2) flat in int v_TileId;
...
layout (std140, binding = 2) uniform Uniforms
{
    ...
    bool u_ShowShadowCascadesBoundaries = 0;
    float shadowFilterSampleScale = 1.0f;
};
