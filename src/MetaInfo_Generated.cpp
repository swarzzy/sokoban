...
InitMetaInfo(AB::MemoryArena* arena)
{
    ...
    AddEntry_EntityType(&info->EntityType, 7, EntityType_Platform, "EntityType_Platform");
    ...
    AddEntry_EntityMesh(&info->EntityMesh, 10, EntityMesh_PrevSphere, "EntityMesh_PrevSphere");
    ...
    AddEntry_EntityMaterial(&info->EntityMaterial, 8, EntityMaterial_OldMetal, "EntityMaterial_OldMetal");
    AddEntry_EntityMaterial(&info->EntityMaterial, 9, EntityMaterial_Box, "EntityMaterial_Box");
    AddEntry_EntityMaterial(&info->EntityMaterial, 10, EntityMaterial_Altar, "EntityMaterial_Altar");
    AddEntry_EntityMaterial(&info->EntityMaterial, 11, EntityMaterial_Cat, "EntityMaterial_Cat");
