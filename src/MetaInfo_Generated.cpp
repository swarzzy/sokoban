...
InitMetaInfo(AB::MemoryArena* arena)
{
    ...
    AddEntry_EntityMesh(&info->EntityMesh, 8, EntityMesh_Box, "EntityMesh_Box");
    AddEntry_EntityMesh(&info->EntityMesh, 9, EntityMesh_Altar, "EntityMesh_Altar");
    ...
    AddEntry_EntityMaterial(&info->EntityMaterial, 10, EntityMaterial_Metal, "EntityMaterial_Metal");
    AddEntry_EntityMaterial(&info->EntityMaterial, 11, EntityMaterial_OldMetal, "EntityMaterial_OldMetal");
    AddEntry_EntityMaterial(&info->EntityMaterial, 12, EntityMaterial_Burlap, "EntityMaterial_Burlap");
    AddEntry_EntityMaterial(&info->EntityMaterial, 13, EntityMaterial_Gold, "EntityMaterial_Gold");
    AddEntry_EntityMaterial(&info->EntityMaterial, 14, EntityMaterial_Gun, "EntityMaterial_Gun");
    AddEntry_EntityMaterial(&info->EntityMaterial, 15, EntityMaterial_Box, "EntityMaterial_Box");
    AddEntry_EntityMaterial(&info->EntityMaterial, 16, EntityMaterial_Altar, "EntityMaterial_Altar");
